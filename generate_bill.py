...
_DISCOUNT_RATES: dict[tuple[int, int], float] = {
    ...
    (2026,  3): 1.5,
    # ── 補助なし ────────────────────────────────────────────────────
    (2026,  4): 0.0, (2026,  5): 0.0, (2026,  6): 0.0,
    # ── 夏季支援（2026年7〜9月） ─────────────────────────────────────
    # 出典: 経済産業省「電気・ガス料金支援」2026年7〜9月分（確定）
    # 低圧: 7月3.5円, 8月4.5円, 9月3.5円
    (2026,  7): 3.5, (2026,  8): 4.5, (2026,  9): 3.5,
}
...
_KWH_RANGE = {
    1:(175,250), 2:(170,240), 3:(110,170), 4:(90,135),
    5:(80,125),  6:(125,180), 7:(190,270), 8:(215,305),
    9:(150,215),10:(95,150), 11:(130,175),12:(160,230),
}
